...
public class FootAdapter extends RecyclerView.Adapter<FootAdapter.ViewHolder> {
    ...
    public void setList(List<MyFootBean.ResultBean> mlist) {
        list.clear();
        if (mlist!=null){
            list.addAll(mlist);
        }
    ...
    public MyFootBean.ResultBean getItem(int position){
        return list.get(position);
    }
    public void addList(List<MyFootBean.ResultBean> mlist) {
        if (mlist!=null){
            list.addAll(mlist);
        }
        notifyDataSetChanged();
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void getdata(MyFootBean.ResultBean item, Context context, int i) {
